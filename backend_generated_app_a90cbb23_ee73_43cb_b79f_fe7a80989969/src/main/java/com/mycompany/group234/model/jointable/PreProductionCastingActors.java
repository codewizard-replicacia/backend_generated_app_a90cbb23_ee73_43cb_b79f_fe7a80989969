...
@Entity(name = "PreProductionCastingActors")
@Table(schema = "\"generated_app\"", name = "\"PreProductionCastingActors\"")
@Data
public class PreProductionCastingActors{
